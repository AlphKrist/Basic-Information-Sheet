...
<div class="container vh-100 d-flex justify-content-center">
  <div class="card my-auto text-center">
...
<table class="table table-bordered table-condensed">
    ...
    if(isset($_POST['submit'])) {
        $search = $_POST['search'];
        $query = "SELECT * FROM table1 WHERE lastname LIKE '%$search%' OR firstname LIKE '%$search%'";
      } else {
      ...
      while($row = mysqli_fetch_assoc($result))
        {
          ...
          echo "<td>"; ?> <button type="button" class="btn btn-danger" name ="delete" onclick="deleteConfirmation(<?php echo $id ?>)">Delete</button></a> <?php echo "</td>";
          ?>
          <script>
